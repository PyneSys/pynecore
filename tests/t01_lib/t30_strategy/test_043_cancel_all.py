...
def __test_cancel_all_removes_every_pending_entry__(script_path, module_key):
    ...
    bars = [
        ...
        OHLCV(timestamp=base_ts + 2 * 60_000, open=100.0, high=125.0, low=99.5, close=125.0, volume=100.0),
        OHLCV(timestamp=base_ts + 3 * 60_000, open=125.0, high=125.5, low=124.5, close=125.0, volume=100.0),
    ]
