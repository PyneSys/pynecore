...
@pyne
"""
__pyne_slot_layout__ = {'main': {'init': (None, 0.5), 'series': ((0, None, 'float'),), 'varip': (), 'children': (), 'names': ('s2', 's2')}, 'main·t': {'init': (None, 1.0), 'series': ((0, None, 'int'),), 'varip': (), 'children': (), 'names': ('s', 's')}}
