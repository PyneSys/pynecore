...
class APIConfig:
    ...
    def from_file(cls, config_path: Path) -> "APIConfig":
        ...
        :raises ValueError: If file doesn't exist or has invalid format
        """
    ...
    def save_to_file(self, config_path: Path) -> None:
        ...
        :param config_path: Path to save TOML configuration file
        """
...
class ConfigManager:
    ...
    @classmethod
    def load_config(cls, config_path: Path | None = None) -> APIConfig:
        """
    ...
    @classmethod
    def save_config(cls, config: APIConfig, config_path: Path | None = None) -> None:
        """
        Save configuration to file.

        :param config: APIConfig instance to save
        :param config_path: Optional path to save config file (defaults to DEFAULT_CONFIG_PATH)
        """
